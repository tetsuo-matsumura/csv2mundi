...
function generateLine(){
	...
	var c1 = rng(2);
	//Coluna 2: Valor do Pagamento (0-10000)
	var c2 = rng(100000);
	//Coluna 3: Bandeira do cartão
	var bandeiras = ["Visa","Mastercard","Hipercard","Amex","Diners","Elo"]
	var c3 = bandeiras[rng(5)];
	...
	var c8d3 = rng(9);
	if (c3 == "Amex"){
		result = c1+","+c2+","+c3+","+c4+","+c5+","+c6d1+c6d2+","+c7+","+c8d1+c8d2+c8d2+c8d3;
		return result;
	}
